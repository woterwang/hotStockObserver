...
export interface IHundredDayHigh {
  ...
  // 百日新高扩展字段
  marketCapitalization?: number;  // 流通市值
  listingDays?: number;           // 上市交易天数
...
const HundredDayHighSchema = new Schema<HundredDayHighDocument>(
  {
...
export const HundredDayHigh =
  (mongoose.models.HundredDayHigh as mongoose.Model<HundredDayHighDocument>) ||
  mongoose.model<HundredDayHighDocument>('HundredDayHigh', HundredDayHighSchema);