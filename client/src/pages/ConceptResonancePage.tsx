...
const ConceptResonancePage: React.FC = () => {
  ...
  const [filterMinScore, setFilterMinScore] = useState(80);
    ...
    <Layout>
      <div className="space-y-3 sm:space-y-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900">🎯 主线共振</h1>
          ...
          <div className="border-b border-gray-200 overflow-x-auto">
            <nav className="flex -mb-px min-w-max">
              <button
                ...
                className={ `px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm font-medium border-b-2 transition whitespace-nowrap ${activeTab === 'scan'
              ...
              <button
                ...
                className={ `px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm font-medium border-b-2 transition whitespace-nowrap ${activeTab === 'signal'
                  ? 'border-blue-500 text-blue-600'
                  : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                  }` }
              >
              ...
              <button
                ...
                className={ `px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm font-medium border-b-2 transition whitespace-nowrap ${activeTab === 'backtest'
                  ? 'border-blue-500 text-blue-600'
                  : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                  }` }
              >
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        { candidates.map((item, idx) => (
                          <tr key={ idx } className="hover:bg-gray-50 cursor-pointer" onClick={ () => goToDetail(item.stockCode) }>
                            ...
                            <td className="px-4 py-3 text-center">
                              <span className={ `px-2 py-1 rounded text-xs font-medium ${item.conceptScore >= 40 ? 'bg-red-100 text-red-800' :
                            ...
                            <td className="px-4 py-3 text-center">
                              <span className={ `px-2 py-1 rounded text-xs font-medium ${(item.strategyScore || 0) >= 80 ? 'bg-red-100 text-red-800' :
                            ...
                            <td className="px-4 py-3 text-center">
                              <span className={ `px-2 py-1 rounded text-xs ${item.riskLevel === 'low' ? 'bg-green-100 text-green-800' :
                ...
                { loading ? (
                  ...
                  <div className="space-y-4">
                    { filteredCandidates.map((item, idx) => (
                      <div
                        key={ idx }
                        className={ `bg-white border rounded-lg p-4 hover:shadow-md transition cursor-pointer ${item.isConceptLeader ? 'border-red-300 bg-red-50' : ''
                          }` }
                      ...
                      >
                        ...
                        <div className="mt-3 flex items-center gap-4 text-sm">
                          <div className="flex items-center gap-1">
                            ...
                            <span className={ `font-bold ${(item.strategyScore || 0) >= 80 ? 'text-red-600' :
                          ...
                          <div className={ `px-2 py-0.5 rounded text-xs ${item.riskLevel === 'low' ? 'bg-green-100 text-green-800' :
                            item.riskLevel === 'medium' ? 'bg-yellow-100 text-yellow-800' :
                              'bg-red-100 text-red-800'
                            }` }>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                              { backtestResult.trades.map((trade, index) => (
                                <tr key={ index } className="hover:bg-gray-50">
                                  ...
                                  <td className="px-4 py-3 text-sm text-center">
                                    <span className={ `px-2 py-1 rounded text-xs ${trade.exitReason === 'take_profit' ? 'bg-red-100 text-red-800' :
