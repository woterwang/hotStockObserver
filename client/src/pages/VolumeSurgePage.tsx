        ...
        <div className="flex items-center gap-4 flex-wrap">
          <div className="flex bg-gray-100 rounded-lg p-1">
            <button
              ...
              className={ `px-4 py-2 rounded-md text-sm font-medium transition ${viewMode === 'today'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white rounded-lg shadow p-4">
              <div className="flex items-center justify-between">
                ...
                <span className={ `px-2 py-1 text-xs font-medium rounded-full ${stats.marketInfo.sentiment >= 60 ? 'bg-green-100 text-green-800' :
              ...
              <div className="mt-2 text-xs">
                <span className={ `font-medium ${stats.marketInfo.advice === 'aggressive' ? 'text-green-600' :
            ...
            <div className="bg-white rounded-lg shadow p-4">
              <div className="flex items-center justify-between">
                ...
                <span className={ `px-2 py-1 text-xs font-medium rounded-full ${stats.avgScore >= 70 ? 'bg-green-100 text-green-800' :
              ...
              <div className="mt-3 space-y-2">
                { stats.industryDistribution.slice(0, 5).map((item, index) => (
                  <div key={ item.name } className="flex items-center justify-between">
                    <div className="flex items-center">
                      <span className={ `w-5 h-5 flex items-center justify-center text-xs font-medium rounded ${index === 0 ? 'bg-red-100 text-red-600' :
                  ...
                  { surgeList.map((stock, index) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-sm text-right">
                        <span
                          className={ `font-medium ${stock.changePercent >= 0
                            ? 'text-red-600'
                            : 'text-green-600'
                            }` }
                        >
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-sm text-right">
                        <span
                          className={ `font-medium ${stock.volumeRatio >= 2
                            ? 'text-red-600'
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-sm text-center">
                        <span
                          className={ `inline-flex items-center px-2 py-1 rounded text-xs font-bold ${(stock.strategyScore || 0) >= 70
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-sm text-center">
                        <span
                          className={ `inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${stock.riskLevel === 'low'
                            ? 'bg-green-100 text-green-700'
